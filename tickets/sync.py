...
def _build_email_from_row(ticket, row, namespace=None, conv_id="", known_outlook_ids=None):
    ...
    # Fast path: short_id already in DB — skip COM entirely
    if known_outlook_ids is not None and short_id in known_outlook_ids:
        return None
    stable_id = short_id
    body = ""
    ...
    # Stable-ID check — catches emails whose short-form ID changed since last sync
